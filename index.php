...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #cb1111, #1f1a6b);
            height: 100vh;
            display: flex;
            justify-content: center;
            align-items: center;
            position: relative;
            /* Aseguramos que el logo se posicione correctamente */
        }
...
<body>
    ...
    <div class="login-logo">
        <a href="https://hospitalsantacruz.cl/">
            <img src="imagen/logohsc.ico" alt="Logo" style="width: 100px; height: 100px; border-radius: 50%;">
        </a>
    </div>
